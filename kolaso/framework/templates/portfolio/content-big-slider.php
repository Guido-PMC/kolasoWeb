<div class="col-sm-12 col-md-12 col-lg-12 mb-80">
  <?php 
    ...
    if (isset($portolfio_images['portfolio_gallery']) && $portolfio_images['portfolio_gallery'] !== '') {
        echo ' <div id="portfolio-img" class="carousel owl-carousel carousel-navs" data-slide="1" data-slide-rs="1" data-autoplay="true" data-nav="true" data-dots="false" data-space="0" data-loop="true" data-speed="800">';
