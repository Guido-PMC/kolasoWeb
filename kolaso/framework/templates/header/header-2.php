<?php
/**
 * The template for displaying header #2 layout
 *
 * @link       zytheme.com
 * @since      1.0.0
 *
...
?>
<header id="navbar-spy" class="header header-2 header-transparent <?php kolaso_get_header_classes();?>">
	<nav id="primary-menu" class="navbar navbar-expand-lg navbar-light<?php kolaso_get_navbar_bordered();kolaso_get_active_sticky();?>">
